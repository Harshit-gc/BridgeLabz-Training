...
class RideService {
    ...
    public Ride bookRide(User user, double distanceKm, FareCalculator fareCalculator)
        ...
        Driver assigned = assignAvailableDriver(); 
...
public class CabBooking {
    public static void main(String[] args) {
        ...
        FareCalculator normal = new NormalFareCalculator(40, 15);      
        FareCalculator peak = new PeakFareCalculator(normal, 1.75);    
