...
public class Palindrome {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Loop Method: " + checkPalindromeLoop(str));
        System.out.println("Recursion Method: " +
                checkPalindromeRecursion(str, 0, str.length() - 1));
        System.out.println("Array Method: " + checkPalindromeArray(str));
        input.close();
    }
}