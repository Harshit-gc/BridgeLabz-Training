...
public class InventoryManagementSystem {
	...
	static ItemNode addAtSpecificPosition(ItemNode Head, int itemId, String itemName, int quantity, double price,
			int pos) {
		ItemNode newNode = new ItemNode(itemId, itemName, quantity, price);
		if (pos == 1) {
	...
	public static void main(String[] args) {
		...
		Head = addAtStart(Head, 1, "Soap", 5, 20.0);
		Head = addAtLast(Head, 4, "Toys", 5, 60.0);
		Head = addAtSpecificPosition(Head, 2, "Watch", 6, 30.0, 2);
		Head = delete(Head, 3);
