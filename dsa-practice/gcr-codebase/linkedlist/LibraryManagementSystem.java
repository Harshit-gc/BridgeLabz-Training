...
public class LibraryManagementSystem {
	...
	static BookNode addAtStart(BookNode Head, BookNode Tail, int bookId, String title, String author, String genre,
			boolean isAvailable) {
	...
	static BookNode addAtLast(BookNode Head, BookNode Tail, int bookId, String title, String author, String genre,
			boolean isAvailable) {
		BookNode newNode = new BookNode(bookId, title, author, genre, isAvailable);
		if (Head == null) {
			Head = Tail = newNode;
	...
	static BookNode addAtSpecificPosition(BookNode Head, int bookId, String title, String author, String genre,
			boolean isAvailable, int pos) {
		if (pos == 1) {
	...
	static void displayForward(BookNode Head) {
		...
		while (curr != null) {
			System.out.println(curr.bookId + " " + curr.title + " " + curr.author + " " + curr.genre + " "
